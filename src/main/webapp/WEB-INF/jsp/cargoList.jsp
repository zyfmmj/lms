                        ...
                        <c:when test="${page.list!=null}">
                            <c:forEach items="${page.list}" var="sendBill">
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${sendBill.sendDate}"/></td>
                                    <td>${sendBill.take}</td>
                                    <td>${sendBill.takePhone}</td>
                                    <td>${sendBill.cargoName}</td>
                                    <td>${sendBill.terminus}</td>
                                    <td>
                                        <input type="button" value="确认收货" class="btn btn-info" onclick="submit(${sendBill.waybillNo})" id="btn-confirm"/></td>
                                </tr>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
                            <p class="text-center">暂无送货清</p>
                        </c:otherwise>
                    </c:choose>
                    <tr>
                        <td colspan="11">
                            ...
                            <span>
										 <a href="/cargoList">&nbsp;首页&nbsp;</a>
										 <a href="/cargoList?pageNo=${page.pageNo-1}">&nbsp;上一页&nbsp;</a>
										 <a href="/cargoList?pageNo=${page.pageNo+1}">&nbsp;下一页&nbsp;</a>
										 <a href="/cargoList?pageNo=${page.pageCount}">&nbsp;末页&nbsp;</a>
									 </span>
                        </td>
                    </tr>
                </table>
