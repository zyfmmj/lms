    ...
    <div class="right"  id="mainFrame">
        ...
        <div class="right_cont">
            ...
            <div style="width:900px;margin:auto;">
                ...
                <form id="add-form" action="/newSendBill" method="post">
                    <jsp:useBean id="now" class="java.util.Date" scope="page"/>
                    <table class="table table-bordered">
                        <tr>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">日期(*):</td>
                            <td width="23%"><input type="text" name="sendDate" class="laydate-icon span1-1" id="Calendar" value="<fmt:formatDate value='${now}'/>" /></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">出发站(*):</td>
                            <td width="23%"><input type="text" name="origin" id="origin" class="span1-1"  /></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">到达站(*):</td>
                            <td width="23%"><input type="text" name="terminus" id="terminus" class="span1-1"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">发货人(*):</td>
                            <td><input type="text" name="give" id="give"  class="span1-1" /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">地址:</td>
                            <td><input type="text" name="giveAddr" id="giveAddr"  class="span1-1" /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">电话(*):</td>
                            <td><input type="text" name="givePhone" id="givePhone"  class="span1-1" /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">收货人(*):</td>
                            <td><input type="text" name="take" id="take"  class="span1-1" /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">地址:</td>
                            <td><input type="text" name="takeAddr" id="takeAddr"  class="span1-1" /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">电话(*):</td>
                            <td><input type="text" name="takePhone" id="takePhone" class="span1-1"  /></td>
                        </tr>
                    </table>
                    <table class="table table-bordered">
                        <tr>
                        ...
                        <tr>
                            <td align="center">
                                <input type="text" name="cargoName" id="cargoName" class=" span2" />
                            </td>
                            <td align="center">
                                <select name="packWay" id="packWay" class=" span1">
                            ...
                            <td align="center">
                                <input type="text" name="cargoNum" id="cargoNum" class=" span1 text-center" value="0" />
                            </td>
                            <td align="center">
                                <input type="text" name="shipCost" id="shipCost" class=" span1 text-center" value="0" readonly="readonly" />
                            </td>
                            <td align="center">
                                <input type="text" name="cargoWeight" id="cargoWeight" class=" span1 text-center" value="0" />
                            </td>
                            <td align="center">
                                <input type="text" name="cargoBulk" id="cargoBulk" class=" span1 text-center" value="0" />
                            </td>
                            <td align="center">
                    ...
                    <table class="table table-bordered" >
                        <tr>
                            ...
                            <td><input type="text" name="insurance" id="insurance" class="span1-1"  /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">保费：</td>
                            <td ><input type="text" name="premium" id="premium-1" class="span1-1"  /></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">服务费：</td>
                            <td ><input type="text" name="serviceCost" id="serviceCost"  class="span1-1" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5"><textarea name="cargoComment" id="cargoComment" class="span10"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">备注：</td>
                            <td colspan="5" nowrap="nowrap"><input type="text" name="comment" id="comment" class="span10"  /></td>
                        </tr>
                    </table>
                </form>
